...
class ReleaseConsistencyTests(unittest.TestCase):
    ...
    def test_bidirectional_grid_contract_is_fixed(self) -> None:
        ...
        self.assertNotIn('CONF_GRID_IMPORT_POWER_ENTITY = "grid_import_power_entity"', const_source)
        self.assertNotIn('CONF_GRID_EXPORT_POWER_ENTITY = "grid_export_power_entity"', const_source)
